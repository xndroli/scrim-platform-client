...
// app/(protected)/dashboard/page.tsx - Simple SSR-safe version
    ...
    <div className="min-h-screen bg-background p-6">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-2">Welcome back to your gaming dashboard</p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          <div className="bg-card border rounded-lg p-6">
            ...
            <p className="text-sm text-muted-foreground">Track your gaming performance</p>
            <div className="mt-4">
          ...
          <div className="bg-card border rounded-lg p-6">
            ...
            <p className="text-sm text-muted-foreground">Your latest game results</p>
            <div className="mt-4">
              <div className="text-2xl font-bold">--</div>
              <div className="text-xs text-muted-foreground">Coming soon</div>
            </div>
          ...
          <div className="bg-card border rounded-lg p-6">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="h-4 w-4 bg-blue-500/20 rounded" />
            </div>
            <p className="text-sm text-muted-foreground">Team statistics and ranking</p>
            <div className="mt-4">
              <div className="text-2xl font-bold">--</div>
              <div className="text-xs text-muted-foreground">Coming soon</div>
            </div>
          ...
          <div className="bg-card border rounded-lg p-6">
            ...
            <p className="text-sm text-muted-foreground">Scheduled tournaments and scrims</p>
            <div className="mt-4">
              <div className="text-2xl font-bold">--</div>
              <div className="text-xs text-muted-foreground">Coming soon</div>
            </div>
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2">
          <div className="bg-card border rounded-lg p-6">
            ...
            <div className="space-y-3">
              <button className="w-full text-left p-3 rounded hover:bg-muted transition-colors">
                <div className="font-medium">Join a Scrim</div>
                <div className="text-sm text-muted-foreground">Find and join practice matches</div>
              </button>
              <button className="w-full text-left p-3 rounded hover:bg-muted transition-colors">
                <div className="font-medium">Create Team</div>
                <div className="text-sm text-muted-foreground">Start your own gaming team</div>
              </button>
              <button className="w-full text-left p-3 rounded hover:bg-muted transition-colors">
                <div className="font-medium">View Leaderboards</div>
                <div className="text-sm text-muted-foreground">Check rankings and standings</div>
              </button>
            </div>
          </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 p-3 rounded bg-muted/50">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-xs text-muted-foreground">Welcome to Raijin!</div>
                </div>
              </div>
            </div>
          </div>
